...
Free Crypto News is a free, no-auth crypto news and market intelligence API served at https://cryptocurrency.cv. Source-available, all rights reserved; the hosted API is free to use. See [LICENSE](https://github.com/nirholas/cryptocurrency.cv/blob/main/LICENSE).
...
| Run or contribute to the codebase | [Developer Guide](./DEVELOPER-GUIDE.md), [Contributing](https://github.com/nirholas/cryptocurrency.cv/blob/main/CONTRIBUTING.md), [Testing](./TESTING.md) |
...
| Payments and premium | [X402.md](./X402.md), [x402scan-discovery.md](./x402scan-discovery.md), [x402-conformance.md](./x402-conformance.md), [PREMIUM.md](./PREMIUM.md), [WELL-KNOWN.md](./WELL-KNOWN.md) |
...
| Other SDK sources | Java [`sdk/java`](https://github.com/nirholas/cryptocurrency.cv/tree/main/sdk/java), R [`sdk/r`](https://github.com/nirholas/cryptocurrency.cv/tree/main/sdk/r), C# [`sdk/csharp`](https://github.com/nirholas/cryptocurrency.cv/tree/main/sdk/csharp), Kotlin [`sdk/kotlin`](https://github.com/nirholas/cryptocurrency.cv/tree/main/sdk/kotlin), Swift [`sdk/swift`](https://github.com/nirholas/cryptocurrency.cv/tree/main/sdk/swift) |
| Postman and OpenAPI | [Postman collection](https://github.com/nirholas/cryptocurrency.cv/blob/main/postman/README.md), [OpenAPI spec](https://github.com/nirholas/cryptocurrency.cv/blob/main/chatgpt/openapi.yaml) |
| Security | [SECURITY.md](./SECURITY.md) (architecture) and the root [security policy](https://github.com/nirholas/cryptocurrency.cv/blob/main/SECURITY.md) |
| Changelog | [../CHANGELOG.md](https://github.com/nirholas/cryptocurrency.cv/blob/main/CHANGELOG.md) |
