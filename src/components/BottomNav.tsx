  ...
  return (
    <nav
      className={cn(
        ...
        "border-t border-[var(--color-border)] bg-[var(--color-surface)]/95 backdrop-blur-md",
          ...
          return (
            <li key={href} className="flex-1">
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ...
                    : "text-[var(--color-text-tertiary)] active:scale-90"
                )}
              ...
              >
                ...
                {isActive && (
                  <span
                    className="absolute top-0 left-1/2 h-0.5 w-6 -translate-x-1/2 rounded-full bg-[var(--color-accent)]"
                    aria-hidden="true"
                  />
                )}
