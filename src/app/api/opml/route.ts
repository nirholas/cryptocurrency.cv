...
const RSS_SOURCES = [
  // Tier 1 — Major Crypto News
  {
    ...
    htmlUrl: 'https://coindesk.com',
    category: 'Crypto News',
  },
  {
    name: 'The Block',
    url: 'https://www.theblock.co/rss.xml',
    htmlUrl: 'https://theblock.co',
    category: 'Crypto News',
  },
  {
    name: 'Decrypt',
    url: 'https://decrypt.co/feed',
    htmlUrl: 'https://decrypt.co',
    category: 'Crypto News',
  },
  {
    name: 'CoinTelegraph',
    url: 'https://cointelegraph.com/rss',
    htmlUrl: 'https://cointelegraph.com',
    category: 'Crypto News',
  },
  {
    name: 'Bitcoin Magazine',
    url: 'https://bitcoinmagazine.com/.rss/full/',
    htmlUrl: 'https://bitcoinmagazine.com',
    category: 'Bitcoin',
  },
  {
    name: 'Blockworks',
    url: 'https://blockworks.co/feed',
    htmlUrl: 'https://blockworks.co',
    category: 'Crypto News',
  },
  {
    name: 'The Defiant',
  ...
  // Tier 2 — Established Crypto
  {
    ...
    htmlUrl: 'https://watcher.guru',
    category: 'Crypto News',
  },
  {
    name: 'Cryptopolitan',
    url: 'https://www.cryptopolitan.com/feed/',
    htmlUrl: 'https://cryptopolitan.com',
    category: 'Crypto News',
  },
  {
    name: 'The Daily Hodl',
    url: 'https://dailyhodl.com/feed/',
    htmlUrl: 'https://dailyhodl.com',
    category: 'Crypto News',
  },
  {
    name: 'CryptoSlate',
    url: 'https://cryptoslate.com/feed/',
    htmlUrl: 'https://cryptoslate.com',
    category: 'Crypto News',
  },
  {
    name: 'U.Today',
    url: 'https://u.today/rss',
    htmlUrl: 'https://u.today',
    category: 'Crypto News',
  },
  {
    name: 'BeInCrypto',
    url: 'https://beincrypto.com/feed/',
    htmlUrl: 'https://beincrypto.com',
    category: 'Crypto News',
  },
  {
    name: 'DL News',
    url: 'https://www.dlnews.com/feed/',
    htmlUrl: 'https://dlnews.com',
    category: 'Crypto News',
  },
  {
    name: 'Protos',
    url: 'https://protos.com/feed/',
    htmlUrl: 'https://protos.com',
    category: 'Crypto News',
  },
  // Mainstream
  {
  ...
  // Bitcoin
  {
    ...
    htmlUrl: 'https://bitcoinops.org',
    category: 'Bitcoin',
  },
  {
    name: 'Stacker News',
    url: 'https://stacker.news/rss',
    htmlUrl: 'https://stacker.news',
    category: 'Bitcoin',
  },
  // DeFi
  {
  ...
  // Solana
  {
    ...
    htmlUrl: 'https://helius.dev',
    category: 'Solana',
  },
  {
    name: 'Solana News',
    url: 'https://solana.com/news/rss.xml',
    htmlUrl: 'https://solana.com',
    category: 'Solana',
  },
  // Security
  {
    ...
    htmlUrl: 'https://chainalysis.com',
    category: 'Security',
  },
  {
    name: 'Ledger Blog',
    url: 'https://www.ledger.com/blog/feed',
    htmlUrl: 'https://ledger.com',
    category: 'Security',
  },
  // Policy
  {
    ...
    htmlUrl: 'https://coincenter.org',
    category: 'Policy',
  },
  {
    name: 'SEC Press Releases',
    url: 'https://www.sec.gov/news/pressreleases.rss',
    htmlUrl: 'https://sec.gov',
    category: 'Policy',
  },
  // Wave 4 — Mainstream
  {
  ...
  },
  {
    ...
    htmlUrl: 'https://fortune.com',
    category: 'Mainstream',
  },
  {
    name: "Barron's",
    url: 'https://www.barrons.com/feed',
    htmlUrl: 'https://barrons.com',
    category: 'Mainstream',
  },
  {
    name: 'Axios Crypto',
    url: 'https://www.axios.com/pro/crypto-deals/feed',
    htmlUrl: 'https://axios.com',
    category: 'Mainstream',
  },
  // Wave 4 — Geopolitical / Central Banks
  {
    ...
    htmlUrl: 'https://bis.org',
    category: 'Policy',
  },
  {
    name: 'IMF Fintech Notes',
    url: 'https://www.imf.org/en/Publications/RSS?type=Fintech%20Notes',
    htmlUrl: 'https://imf.org',
    category: 'Policy',
  },
  {
    name: 'Atlantic Council',
    url: 'https://www.atlanticcouncil.org/category/programs/geoeconomics/feed/',
    htmlUrl: 'https://atlanticcouncil.org',
    category: 'Policy',
  },
  // Wave 4 — On-chain
  {
    ...
    htmlUrl: 'https://santiment.net',
    category: 'Research',
  },
  // Wave 4 — Social
  {
    name: 'Farcaster Blog',
    url: 'https://www.farcaster.xyz/blog/rss.xml',
    htmlUrl: 'https://farcaster.xyz',
    category: 'Social',
  },
  {
    name: 'Lens Protocol Blog',
    url: 'https://lens.xyz/blog/rss.xml',
    htmlUrl: 'https://lens.xyz',
    category: 'Social',
  },
  // Wave 4 — TradFi / RWA
  {
    name: 'Securitize Blog',
    url: 'https://securitize.io/blog/rss.xml',
    htmlUrl: 'https://securitize.io',
    category: 'TradFi',
  },
  // Wave 4 — ETF
  {
    name: 'Fidelity Digital Assets',
    url: 'https://www.fidelitydigitalassets.com/blog/rss.xml',
    htmlUrl: 'https://fidelitydigitalassets.com',
    category: 'ETF',
  },
];
...
export async function GET() {
  const outlines = RSS_SOURCES.map(
    (source) =>
