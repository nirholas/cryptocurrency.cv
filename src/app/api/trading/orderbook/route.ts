      ...
      case 'slippage': {
        ...
        if (side === 'both') {
          ...
          responseData = {
            ...
            comparison: {
              betterSide:
                buySlippage.slippagePercent < sellSlippage.slippagePercent ? 'buy' : 'sell',
            ...
            overall:
              liquidity.liquidityScore >= 80
                ...
                : liquidity.liquidityScore >= 60
                  ? 'good'
                  : liquidity.liquidityScore >= 40
                    ? 'moderate'
                    : 'poor',
            recommendation:
              liquidity.bidAskRatio > 1.3
                ? 'heavy_buying_pressure'
                : liquidity.bidAskRatio < 0.7
                  ? 'heavy_selling_pressure'
                  : 'balanced',
          },
        };
        break;
