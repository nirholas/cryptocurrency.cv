  ...
  return (
    <>
      ...
      <main className="container-main flex min-h-[60vh] flex-col items-center justify-center py-20 text-center">
        <h1 className="mb-4 font-serif text-4xl font-bold">Article unavailable</h1>
        <p className="text-text-secondary mb-4 max-w-md">
          We couldn&apos;t load this article right now. Please try again or browse the latest news.
        </p>
        {error?.digest && (
