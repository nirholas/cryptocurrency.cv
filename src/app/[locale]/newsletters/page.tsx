      ...
      <main id="main-content" className="min-h-screen">
        ...
        <section className="border-b border-[var(--color-border)]">
          <div className="container-main py-10 text-center lg:py-14">
            ...
            <h1 className="mb-4 font-serif text-3xl font-bold text-[var(--color-text-primary)] md:text-4xl lg:text-5xl">
              Newsletters
            </h1>
            <p className="mx-auto mb-6 max-w-2xl text-lg text-[var(--color-text-secondary)]">
